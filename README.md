...
| Symbol | Timeframe |
|--------|-----------|
| BTCUSDm | M15 (execution), H1/H4/D1 (bias) |
...
data = {
    "M15": connector.get_candles("BTCUSDm", "M15", 5000),
    "D1": connector.get_candles("BTCUSDm", "D1", 500),
}
...
Frozen dataclass configs for symbols (BTCUSDm), timeframes (M15/H1/H4/D1), risk limits (1% per trade, 3% daily max, 6% weekly max, 1 open trade max)
