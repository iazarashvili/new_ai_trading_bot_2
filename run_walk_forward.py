...
def main():
    ...
    for symbol in SETTINGS.symbols:
        ...
        data = {
            "M15": connector.get_candles(symbol, "M15", M15_COUNT),
            "D1": connector.get_candles(symbol, "D1", D1_COUNT),
        }
...
""")
        ...
        if m.total_trades == 0:
            print("\n   0 ტრეიდი OOS-ში — სტრატეგია შეიძლება არ გადაიდოს ახალ მონაცემებზე.")
